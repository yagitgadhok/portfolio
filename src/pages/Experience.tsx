...
const Experience = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      <h2 className="text-5xl font-bold font-serif text-white text-center mb-12">
        Experience
      </h2>
      ...
      <div className="relative">
        ...
        {experiences.map((exp, index) => (
          ...
          >
            ...
            {/* Timeline Content */}
            <div
              className={`bg-slate-900 p-6 rounded-lg shadow-lg border border-gray-800 w-5/12 ${
                index % 2 === 0 ? "text-right" : "text-left"
              }`}
            >
              <h3 className="text-lg font-extrabold text-white">{exp.role}</h3>
              <p className="text-slate-400 font-medium font-semibold">
